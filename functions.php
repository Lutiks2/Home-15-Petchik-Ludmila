...
if (!function_exists('notify_setup')) :
    ...
    function notify_setup()
    {
        ...
        register_nav_menus(array(
            'header' => esc_html__('App menu', 'notify'),
            'footer' => esc_html__('Footer menu', 'notify')
        ));
...
function notify_scripts()
{
    ...
    wp_enqueue_style('notify-main-style',get_template_directory_uri().'../css/main.css');
//      wp_enqueue_style('notify-style', get_stylesheet_uri().'../css/main.css');
